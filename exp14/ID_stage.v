...
<<<<<<< HEAD:myCPU/ID_stage.v
    input [63:0] IF_to_ID_bus,
    output ID_to_EXE_valid,
    output [157:0] ID_to_EXE_bus,
    output [32:0] br_bus,
    input [37:0] WB_to_rf_bus,
    input out_WB_valid,
    input [75:0] EXE_to_MEM_bus,
    input out_EXE_valid,
...
=======
    ...
    input out_MEM_valid,
    input exec_flush
>>>>>>> 2425788923d679463b72f5021ceb8168fbbf4bbe:exp14/ID_stage.v
);
...
assign {ID_inst[31:0], ID_pc[31:0]} = IF_to_ID_bus_r[63:0];
wire        rf_we   ;
wire [ 4:0] rf_waddr;
wire [31:0] rf_wdata;
=======
...
<<<<<<< HEAD:myCPU/ID_stage.v
    assign rf_conflict = (~rj_zero & rj_con_from_mem) |
                       (~rkd_zero & rkd_con_from_mem);
    
    assign ID_to_EXE_valid = ID_valid && ID_ready_go;
    assign ID_to_EXE_bus[157:0] = {
=======
