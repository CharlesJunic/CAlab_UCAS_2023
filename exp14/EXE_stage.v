...
<<<<<<< HEAD:myCPU/EXE_stage.v
    input [157:0] ID_to_EXE_bus,
    output EXE_to_MEM_valid,
    output [75:0] EXE_to_MEM_bus,
    output data_sram_en,
...
=======
    ...
    output out_EXE_valid,
    input exec_flush
>>>>>>> 2425788923d679463b72f5021ceb8168fbbf4bbe:exp14/EXE_stage.v
);

reg EXE_valid;
wire EXE_ready_go;
<<<<<<< HEAD:myCPU/EXE_stage.v
reg [157:0] ID_to_EXE_bus_r;
...
>>>>>>> 2425788923d679463b72f5021ceb8168fbbf4bbe:exp14/EXE_stage.v
    ...
    EXE_dest[4:0],
<<<<<<< HEAD:myCPU/EXE_stage.v
    EXE_alu_op[11:0] } = ID_to_EXE_bus_r[157:0];
=======
...
wire EXE_op_w;
assign data_sram_valid = EXE_mem_we & EXE_valid;
